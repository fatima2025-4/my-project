...
document.addEventListener('DOMContentLoaded', function() {
    // Get the profile icon and dropdown menu elements
    const profileIcon = document.getElementById('profileIcon');
    const dropdownMenu = document.getElementById('DM2');
    
    // Toggle dropdown menu visibility when clicking the profile icon
    ...
    const menuItems = dropdownMenu.querySelectorAll('li:not(.divider)');
